...
<head>
    ...
    <title>Fixed Bookings - Guider Dashboard</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="submenu" style="display: block;">
                ...
                <a href="{{ route('guider.fixed-bookings') }}" class="submenu-item active">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                <h1 class="page-title">Fixed Bookings</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Fixed Bookings</li>
                    </ol>
                </nav>
            </div>
        </div>
        
        <!-- Upcoming Fixed Bookings -->
        <?php
            $today = \Carbon\Carbon::today()->toDateString();
            $gId = session('guider_id');
            $upcomingBookings = collect();
            
            // Note: Fixed bookings don't currently have a guider assignment field
            ...
            <div class="col-12">
                <div class="booking-card">
                    <div class="booking-header">
                        <h3 class="booking-title">Upcoming Fixed Bookings</h3>
                    </div>
                    <div class="booking-body">
                        <p class="text-muted">Fixed bookings are not currently assigned to specific guiders in the system.</p>
                        <p class="text-muted">This page will display fixed bookings assigned to you once the system is updated.</p>
                    </div>
                </div>
            </div>
        </div>
