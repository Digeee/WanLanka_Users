...
<head>
    ...
    <title>Individual Bookings - Guider Dashboard</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="submenu" style="display: block;">
                <a href="{{ route('guider.individual-bookings') }}" class="submenu-item active">
                    <i class="fas fa-user"></i>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                <h1 class="page-title">Individual Bookings</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Individual Bookings</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="booking-card">
                    <div class="booking-header">
                        <h3 class="booking-title">Upcoming Individual Bookings</h3>
                    </div>
                    <div class="booking-body">
                        @forelse($upcomingBookings as $booking)
                            <div class="booking-card">
                                <div class="booking-header">
                                    <h4 class="booking-title">Booking #{{ $booking->id }}</h4>
                                </div>
                                <div class="booking-body">
                        ...
                        @empty
                            <p class="text-muted mb-0">No upcoming individual bookings.</p>
                        @endforelse
                    </div>
                </div>
            </div>
